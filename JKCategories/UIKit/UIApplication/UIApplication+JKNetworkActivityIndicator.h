//
//  UIApplication+JKNetworkActivityIndicator.h
...
/**
 Reference: <https://github.com/mdznr/NetworkActivityIndicator>
 
 This category will automatically keep track of concurrent network activity and
 display the network activity indicator accordingly.
 */
